...
// Called from block-ui-directive for the 'demo' instance.
...
blkUI.directive('blockUi', ["blockUiCompileFn", function (blockUiCompileFn) {
  ...
  return function ($scope, $element, $attrs) {
    ...
    // If this is the demo (topmost) block element we'll also need to block any
    // location changes while the block is active.
...
// This file is already embedded in your demo javascript output, there's no need to include this file
